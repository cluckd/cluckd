...
// Copyright (c) 2013-2015 The darkestdimecoin developers
...
#if defined(NDEBUG)
# error "darkestdimecoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "darkestdimecoin Signed Message:\n";
