...
static const unsigned int timeMainGenesisBlock = 0;
uint256 hashMainGenesisBlock("0x");
...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed1.BADDDcoin.org", "seed1.BADDDcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed2.BADDDcoin.org", "seed2.BADDDcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed3.BADDDcoin.org", "seed3.BADDDcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed4.BADDDcoin.org", "seed4.BADDDcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed5.BADDDcoin.org", "seed5.BADDDcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed6.BADDDcoin.org", "seed6.BADDDcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed7.BADDDcoin.org", "seed7.BADDDcoin.org"));
        vSeeds.push_back(CDNSSeedData("seed8.BADDDcoin.org", "seed8.BADDDcoin.org"));
