...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BADDD");
    case cBTC: return QString("cBADDD");
    case mBTC: return QString::fromUtf8("mBADDD");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("darkestdimecoins");
    case cBTC: return QString("Centum-darkestdimecoins (1 / 100)");
    case mBTC: return QString("Milli-darkestdimecoins (1 / 1,000)");
    default: return QString("???");
    }
}
